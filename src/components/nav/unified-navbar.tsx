...
const CENTER_NAV_AUTHED = [
  ...
  { href: "/supervision", label: "Supervision", requiresPro: true },
  { href: "/pricing", label: "Tarifs" },
] satisfies readonly CenterNavItem[];
            ...
            <>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem asChild className={cn(plan !== "pro" ? "pointer-events-none opacity-70" : undefined)}>
                    <Link href="/supervision/automation">Automation — validation</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className={cn(plan !== "pro" ? "pointer-events-none opacity-70" : undefined)}>
                    <Link href="/app/agent-control">Panneau agent</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
