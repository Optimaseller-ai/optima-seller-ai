...
import { addProduct, deleteProduct, reindexCatalogKnowledge } from "./actions";
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--brand-navy)]/65">
            Produits, connaissance business et documents — source unique pour les agents IA.
          </p>
        </div>
        <form
          action={async () => {
            "use server";
            await reindexCatalogKnowledge();
          }}
        >
          <Button type="submit" variant="outline" className="bg-white">
            Réindexer pour les agents
          </Button>
        </form>
      </div>
